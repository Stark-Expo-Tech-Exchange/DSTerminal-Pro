...
CONFIG = {
    ...
    'UPDATE_URL': 'https://github.com/Stark-Expo-Tech-Exchange/DSTerminal-Pro.git',
...
"""
    ...
    def run(self):
        """Main terminal loop"""
        print(f"{Fore.GREEN}DSTerminal v2.0.113 'help' for commands | Workspace: ~/DSTerminal_Workspace{Style.RESET_ALL}")
...
# In the integrity monitor section of handle_command, update the monitor subcommand:
    ...
    # Check integrity
        ...
        # Generate report - FIXED: Use the correct method name
            report_file = self.integrity.generate_report(changes, scan_results)
        
        # Display mitigation summary
            self.integrity._display_mitigation_summary(changes)
        
            if self.integrity.colorama_available:
...
# ==================== HELP MENU ====================
    ...
    # Create header
        ...
        print(f"{Fore.RED}║{Fore.CYAN}{'DSTerminal v2.0.113 nd Reference Manual'.center(terminal_width-2)}{Fore.RED}║{Style.RESET_ALL}")
